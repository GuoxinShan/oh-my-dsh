/**
 * Build config for dsh-model-efforts-editor, distilled from the harness's
...
export default defineConfig([
  ...
  {
    name: 'dsh-model-efforts-editor/client',
    ...
    outputOptions: {
      ...
      banner: 'window.__ModuleLoader__.load({ id: "dsh-model-efforts-editor", factory: (require) => {',
