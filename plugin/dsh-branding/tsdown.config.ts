/**
 * Build config for dsh-branding, distilled from the harness's
 ...
 *
 * No CSS-modules pipeline: the wordmark styles itself inline with --dsw-*
...
export default defineConfig([
  ...
  },
  {
    ...
    outputOptions: {
      ...
      banner: 'window.__ModuleLoader__.load({ id: "dsh-branding", factory: (require) => {',
