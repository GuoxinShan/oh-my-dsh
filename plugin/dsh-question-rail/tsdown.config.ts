/**
 * Build config for dsh-question-rail, distilled from the harness's
...
export default defineConfig([
  ...
  },
  {
    ...
    outputOptions: {
      ...
      banner: 'window.__ModuleLoader__.load({ id: "dsh-question-rail", factory: (require) => {',
