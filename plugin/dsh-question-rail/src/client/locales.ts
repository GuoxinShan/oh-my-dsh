 ...
 * expanded panel's header, the safety-cap notice, and the fallback text for
 * attachment-only messages. Both locales ship together (M2 bilingual posture).
 */
export const zh = {
  'rail.ariaLabel': '我的问题刻度尺',
  'panel.header': '我的问题（{count}）',
  'panel.cappedSuffix': '更早的未载入',
...
export const en = {
  ...
  'panel.cappedSuffix': 'older not loaded',
