...
if (questionRailPackage.name !== 'dsh-question-rail' || questionRailPackage.version !== '0.4.0') {
  throw new Error(`desktop requires dsh-question-rail 0.4.0, found ${questionRailPackage.name}@${questionRailPackage.version}`)
}
