...
if (questionRailPackage.name !== 'dsh-question-rail' || questionRailPackage.version !== '0.1.0') {
  throw new Error(`desktop requires dsh-question-rail 0.1.0, found ${questionRailPackage.name}@${questionRailPackage.version}`)
}
